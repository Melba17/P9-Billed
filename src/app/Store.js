...
// Ce fichier permet de communiquer avec une API pour manipuler des données liées aux utilisateurs (users) et aux factures (bills). Il utilise la classe Api pour gérer les requêtes HTTP (GET, POST, PATCH, DELETE) et offre une interface pratique via la classe Store pour interagir avec l'API dans d'autres parties de l'application
