// Ce fichier met en place un sélecteur de date interactif, qui permet à l'utilisateur (employé/admin) de choisir une date dans une interface visuelle intuitive. Il gère des aspects tels que la navigation entre mois et années, la validation des dates disponibles, et le formatage des dates sélectionnées. L'ensemble est personnalisable via des options passées lors de l'initialisation
