// Ce fichier est un contrôleur de navigation pour une application SPA (Single Page Application). Il définit comment l'application passe d'une vue à une autre (comme la page de connexion, les factures, le tableau de bord, etc.), tout en manipulant l'historique de navigation et en gérant les changements d'URL sans recharger la page (surtout employé mais aussi admin)
