...
// Ce fichier génère et exporte une interface utilisateur pour un tableau de bord administratif, principalement centré sur la gestion des factures et leur validation. La page affiche les factures regroupées en trois catégories : en attente, validées, et refusées, avec des options pour visualiser plus de détails sur chacune
