...
// Ce fichier génère une interface utilisateur pour la soumission d'une nouvelle note de frais. L'utilisateur peut entrer tous les détails pertinents liés à une dépense de travail, comme le type de dépense, le montant, la TVA, et ajouter un justificatif (fichier). Une fois les informations remplies, l'utilisateur peut soumettre le formulaire pour que la note de frais soit traitée par le système
