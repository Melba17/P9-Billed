...
// Fichier Administrateur
// Ces tests unitaires aident à s'assurer que l'interface utilisateur se comporte comme prévu pour diverses situations (certains éléments (boutons, champs de texte) apparaissent uniquement dans les bons contextes) et états des factures  (en attente, acceptée, refusée), en fonction des données passées au composant
